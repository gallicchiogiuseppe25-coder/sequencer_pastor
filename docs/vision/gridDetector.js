...
(function () {
  ...
  // Sotto questa luminosità relativa (o sopra saturazione 0.30) una cella
  // non-stampa conta come clutter (penalità); sopra, è considerata un
  // artefatto di illuminazione (riflesso, glare) e trattata come bianco.
  const CLUTTER_MIN_RELATIVE_DARKNESS = 0.78;
  ...
  function classifyCells(cells, whiteRef, imageData) {
    return cells.map((cell) => {
      ...
      if (looksNonWhite) {
        ...
        // Il clutter (penalità di confidenza) è riservato a ciò che è
        // DAVVERO scuro o saturo ma non-stampa. Le celle "borderline
        // chiare" — appena sotto la soglia, tipiche di riflessi sul vetro,
        // glare, ombre lievissime — vengono trattate come BIANCO: silenzio,
        // nessuna penalità. Evita che un riflesso passeggero faccia
        // crollare la confidenza e perdere l'aggancio durante la lettura.
        const clearlyDark =
          relativeValue < CLUTTER_MIN_RELATIVE_DARKNESS || cell.saturation > 0.30;
        isClutter = !isColored && clearlyDark;
      }
